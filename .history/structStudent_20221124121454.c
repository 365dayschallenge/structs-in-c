...
int main(){
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        printf("Name of student: %d, : %s", i,students[i].name);
        printf("Course of student %d, : %s", i,students[i].course);
        printf("Reg. No of student %d, : %s",i, students[i].reg_no);
        printf("Home ofstudent %d, : %s",i, students[i].home);
    }
