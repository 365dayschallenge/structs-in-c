...
int main(){
    ...
    struct Student student3 = {"Peter", "Bsc IT", "9101", "Narok"};
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        printf("Name of student"[i],"%s", students[i].name);
        printf("Course of student"[i], "%s", students[i].course);
        printf("Reg. No of student"[i], "%s", students[i].reg_no);
        printf("Home ofstudent"[i], "%s", students[i].home);
    }
